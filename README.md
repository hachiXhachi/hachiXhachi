...
<div>
<span class="progress">
<span style="background-color: #563d7c;width: 48.143%;margin-right: 0.983%;" class="progress-item"></span><span style="background-color: #4F5D95;width: 41.353%;margin-right: 0.844%;" class="progress-item"></span><span style="background-color: #f34b7d;width: 3.327%;margin-right: 0.068%;" class="progress-item"></span><span style="background-color: #e34c26;width: 3.093%;margin-right: 0.063%;" class="progress-item"></span><span style="background-color: #878787;width: 1.785%;margin-right: 0.036%;" class="progress-item"></span><span style="background-color: #f1e05a;width: 0.255%;margin-right: 0.005%;" class="progress-item"></span><span style="background-color: #c6538c;width: 0.046%;margin-right: 0.000%;" class="progress-item"></span>
</span>
</div>
